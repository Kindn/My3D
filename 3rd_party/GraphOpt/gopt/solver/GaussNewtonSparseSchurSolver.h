/*
 * filename: GaussNewtonSparseSchurSolver.h
...
*/
class GaussNewtonSparseSchurSolver : public OptSolverBase, public std::enable_shared_from_this<GaussNewtonSparseSchurSolver> {
    friend class FactorGraph;
public: 
    GaussNewtonSparseSchurSolver(): 
    OptSolverBase() {}
    virtual ~GaussNewtonSparseSchurSolver() {}
