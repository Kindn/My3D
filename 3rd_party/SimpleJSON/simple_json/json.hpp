...
namespace sjson
{
    ...
    class JsonReader : public std::enable_shared_from_this<JsonReader>
    {
        ...
        public:
            char currChar() const;
            char getChar();
            std::string strAhead(size_t n) const;
            std::string getStr(size_t n);
    ...
    class JsonNode : public std::enable_shared_from_this<JsonNode>
    {
        ...
        public:
            bool      set_array(size_t _size = 0);
            JsonNode& array_get(size_t _index);
            const JsonNode& array_get(size_t _index) const;
            void      array_insert(JsonNode_P _node, size_t _index);
            void      array_erase(size_t _index);

            bool      obj_has_item(const std::string& _key) const;
            JsonNode& obj_get_item(const std::string& _key);
            const JsonNode& obj_get_item(const std::string& _key) const;
        ...
        public:
            ...
            const JsonNode& operator [] (const std::string& _key) const;
            JsonNode& operator [] (size_t _array_ind);
            const JsonNode& operator [] (size_t _array_ind) const;
            ...
            std::vector<JsonNode_P> as_vector() const;
