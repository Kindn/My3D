...
public: 
    struct Config {
        ...
        /* Minimum triangulation angle (in degree) of moving camera. This parameter is used 
           to distinguish between pure rotation (panoramic) and plannar scene 
           (plannar) for non-genera scene */
...
public: 
    ...
    bool estimateRelativePose(const EigenVec<Eigen::Vector2d> &essential_inliers1, 
