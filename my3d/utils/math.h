 ...
 */
template <typename T>
inline T computeLinearInterpolation(const T &x1, const T &x2, const double &a) {
 ...
 */
template <typename T>
inline T computeLinearInterpolation(const T &x1, const T &x2, const double &s1,
                                    const double &s2, const double &s) {
 ...
 */
template <typename T>
inline T computeBilinearInterpolation(const T &x11, const T &x12, const T &x21,
                                      const T &x22, const double &a,
                                      const double &b) {
 ...
 * @brief Compute bilinear interpolation
 *
 * @retval (x11 + (s - s1) / (s2 - s1) * x12) + (t - t1) / (t2 - t1) * (x21 + (s
 * - s1) / (s2 - s1) * x22)
 */
template <typename T>
inline T computeBilinearInterpolation(const T &x11, const T &x12, const T &x21,
                                      const T &x22, const double &s1,
                                      const double &s2, const double &t1,
                                      const double &t2, const double &s,
                                      const double &t) {
 ...
 */
template <typename T>
inline T clamp(const T &quantity, const T &lower, const T &upper) {
