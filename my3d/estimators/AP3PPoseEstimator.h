 ...
 * Reference: 
 *      T. Ke and S. I. Roumeliotis, "An Efficient Algebraic Solution to the Perspective-Three-Point 
 *      Problem," 2017 IEEE Conference on Computer Vision and Pattern Recognition (CVPR), Honolulu, 
 *      HI, USA, 2017, pp. 4618-4626, doi: 10.1109/CVPR.2017.491.
*/
...
public: 
    ...
    explicit AP3PPoseEstimator(const Eigen::Matrix3d &K = Eigen::Matrix3d::Identity()): 
    K_{K} {
     ...
     * @param Rs[out]     the solutions of camera frame's orientation w.r.t reference frame 
     * @param ts[out]     the solutions of camera frame's translation w.r.t reference frame 
    */
    int computePose(const VecXData &x_data, 
