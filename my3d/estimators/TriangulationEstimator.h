...
typedef LORANSAC<TriangulationEstimator, TriangulationEstimator> RobustTriangulationEstimator; 
...
public: 
    ...
    struct PoseData {
        ...
        proj_matrix{_proj_matrix}, proj_center{_proj_center}, camera{_camera} {
                 }
    ...
    explicit TriangulationEstimator(const double &min_tri_angle_deg = 5.0, 
                                    const EstimationErrorType &error_type = EstimationErrorType::ANGULAR_ERROR): 
