 ...
 * 
 * The homography H is expressed as: H = K2 * (R - t.transpose() * n) * K1.inverse() / scale
...
*/
void decomposeHomography(const Eigen::Matrix3d &H, 
 ...
 * @param points_3d[out]  the 3D coordinates of points that satisfy the cheirality constraint
*/
