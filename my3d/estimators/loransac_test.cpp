#define TEST_NAME "estimators/loransac_test"
...
BOOST_AUTO_TEST_CASE(TestHomography) {
  ...
  my3d::estimator::LORANSAC<typename my3d::estimator::HomographyEstimator,
                            typename my3d::estimator::HomographyEstimator>
      ransac(config);

  my3d::estimator::LORANSAC<
      typename my3d::estimator::HomographyEstimator,
      typename my3d::estimator::HomographyEstimator>::Report report =
      ransac.estimate(x_data, y_data);
