...
double computeSquaredSampsonError(const Eigen::Vector2d &point1, 
    ...
    // const double error_alg = point2.homogeneous().dot(E * point1.homogeneous());
    // const double den = (E * point1.homogeneous()).hnormalized().squaredNorm() + 
    //                    (E.transpose() * point2.homogeneous()).hnormalized().squaredNorm();
