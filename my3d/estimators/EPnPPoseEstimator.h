 ...
 * Reference:
 *      F. Moreno-Noguer, V. Lepetit and P. Fua, "Accurate Non-Iterative 𝑂(𝑛)
 * Solution to the P𝑛P Problem," 2007 IEEE 11th International Conference on
 * Computer Vision, Rio de Janeiro, Brazil, 2007, pp. 1-8,
...
public:
   ...
   * @param R[out]      the solution of camera frame's orientation w.r.t
   * reference frame
   * @param t[out]      the solution of camera frame's translation w.r.t
   * reference frame
   */
  bool computePose(const VecXData &x_data, const VecYData &y_data,
