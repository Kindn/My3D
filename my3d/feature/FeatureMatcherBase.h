...
public:
    ...
    FeatureMatcherBase(const FeatureMatcherBase<DescriptorListType> &other) = delete;
    FeatureMatcherBase<DescriptorListType> &operator=(const FeatureMatcherBase<DescriptorListType> &other) = delete; 

    virtual void config(const FeatureMatcherBase<DescriptorListType>::Config &config) {
