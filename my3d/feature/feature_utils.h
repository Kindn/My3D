...
public: 
    ...
    */
    const Eigen::MatrixXd &operator [] (const size_t &level_idx) const { return levels_[level_idx]; }
    // const base::Image &operator [] (const size_t &level_idx) const { return levels_[level_idx]; }

    /**
     * @brief Get the reference of level with given index 
    */
    Eigen::MatrixXd &operator [] (const size_t &level_idx) { return levels_[level_idx]; }
    // base::Image &operator [] (const size_t &level_idx) { return levels_[level_idx]; }
    ...
    */
    Eigen::Vector2d computeGradient(const size_t &x, const size_t &y, const size_t &level_idx) const; 
...
public: 
    ...
    */
    bool isExtremumPoint(const size_t &valid_level_idx, 
                         const size_t &x, 
                         const size_t &y, 
     ...
     * 
     * @param valid_level    index of valid DoG level (0 <= valid_level < levels_.size() - 2)
    ...
    */
    size_t detectExtrema(const size_t &valid_level_idx, 
    ...
    */
    bool computeSubPixelExtremumPosition(const size_t &x, 
                                         const size_t &y, 
    ...
    */
    Eigen::Vector3d computeGradient(const size_t &x, 
                                    const size_t &y, 
    ...
    */
    Eigen::Matrix3d computeHessian(const size_t &x, 
                                   const size_t &y, 
                                   const size_t &valid_level_idx) const; 
...
template <typename KeyPointListType, typename DescriptorListType> 
using FeatureImageList = EigenVec<FeatureImage<KeyPointListType, DescriptorListType>>;
