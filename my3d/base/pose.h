 ...
 * @param angle  the angle of rotation around axis (in rad, sign is determined by the right hand rule)
...
/**
 * @brief Get the corresponding rotation matrix of an intrinsic x-y-z (roll-pitch-yaw) Euler angle.
 * Unit: rad
*/
...
/**
 * @brief Compute the projection matrix corresponding to the given camera matrix K and relative pose [R t]
*/
...
/**
 * @brief Perform cheirality constraint test. The extrinsics of camera 1 is [I | 0] and 
 * the extrinsics of camera 2 is [R | t]
*/
