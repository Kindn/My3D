 ...
 */
std::string simplify_string(std::string const &str) {
  std::string ret;
...
void CameraDatabase::add(std::string const &maker, std::string const &model,
                         float sensor_width_mm, float sensor_height_mm,
                         int sensor_width_px, int sensor_height_px) {
  this->data.push_back(CameraInfo());
  CameraInfo &cam = this->data.back();
...
CameraInfo const *CameraDatabase::lookup(std::string const &maker,
...
CameraDatabase::CameraDatabase(void) {
  ...
  /* Cameras from HP. */
  this->add("Hewlett-Packard", "HP PhotoSmart R707 (V01.00)", 7.144f, 5.358f,
            2608, 1952);
  this->add("Hewlett-Packard", "HP PhotoSmart C935 (V03.46)", 7.144f, 5.358f,
            2608, 1952);
  this->add("Hewlett-Packard", "HP PhotoSmart C850 (V05.26)", 7.144f, 5.358f,
            2272, 1712);
  this->add("Hewlett-Packard", "HP PhotoSmart C812 (V09.33)", 7.144f, 5.358f,
            2272, 1712);

  /* Cameras from Kodak. */
  this->add("EASTMAN KODAK COMPANY", "KODAK EasyShare Z981 Digital Camera",
            6.08f, 4.56f, 4288, 3216);
  this->add("EASTMAN KODAK COMPANY", "KODAK EASYSHARE Z950 DIGITAL CAMERA",
            6.08f, 4.56f, 4000, 3000);
  this->add("EASTMAN KODAK COMPANY", "KODAK C875 ZOOM DIGITAL CAMERA", 7.144f,
            5.358f, 3264, 2448);
  this->add("EASTMAN KODAK COMPANY", "KODAK Z612 ZOOM DIGITAL CAMERA", 5.744f,
            4.308f, 2848, 2144);
  this->add("EASTMAN KODAK COMPANY", "KODAK Z650 ZOOM DIGITAL CAMERA", 5.744f,
            4.308f, 2848, 2144);
  this->add("EASTMAN KODAK COMPANY", "KODAK P850 ZOOM DIGITAL CAMERA", 5.744f,
            4.308f, 2592, 1994);
  this->add("EASTMAN KODAK COMPANY", "KODAK P880 ZOOM DIGITAL CAMERA", 7.144f,
            5.358f, 3264, 2448);
  this->add("EASTMAN KODAK COMPANY", "KODAK Z740 ZOOM DIGITAL CAMERA", 5.744f,
            4.308f, 2576, 1932);
  this->add("EASTMAN KODAK COMPANY", "KODAK DX7590 ZOOM DIGITAL CAMERA", 5.744f,
            4.308f, 2576, 1932);
  ...
  this->add("Konica Minolta Camera, Inc.", "DiMAGE Z2", 5.744f, 4.308f, 2272,
            1704);
  ...
  this->add("OLYMPUS IMAGING CORP.", "u-miniD,Stylus V", 5.744f, 4.308f, 2272,
            1704);
  ...
  this->add("OLYMPUS OPTICAL CO.,LTD", "E-20,E-20N,E-20P", 8.8f, 6.6f, 2560,
            1920);
  ...
  /* Cameras from Pentax. */
  this->add("RICOH IMAGING COMPANY, LTD.", "PENTAX K-3", 23.5f, 15.6f, 6016,
            4000);
  ...
  this->add("PENTAX RICOH IMAGING", "PENTAX WG-3 GPS", 6.17f, 4.55f, 4608,
            3456);
  this->add("PENTAX RICOH IMAGING", "PENTAX WG-3 GPS", 6.17f, 4.55f, 4608,
            3456);
  ...
  this->add("PENTAX Corporation", "PENTAX Optio A20", 5.744f, 4.308f, 3648,
            2736);
  this->add("PENTAX Corporation", "PENTAX Optio M20", 5.744f, 4.308f, 3072,
            2304);
  ...
  this->add("PENTAX Corporation", "PENTAX Optio A10", 7.144f, 5.358f, 3264,
            2448);
  this->add("PENTAX Corporation", "PENTAX *ist DS", 23.5f, 15.7f, 3008, 2008);
  this->add("PENTAX Corporation", "PENTAX Optio S5i", 5.744f, 4.308f, 2560,
            1920);
  this->add("PENTAX Corporation", "PENTAX Optio 750Z", 7.144f, 5.358f, 3056,
            2296);
  this->add("PENTAX Corporation", "PENTAX *ist D", 23.5f, 15.7f, 3008, 2008);
  this->add("PENTAX Corporation", "PENTAX Optio 550", 7.144f, 5.358f, 2592,
            1944);
  this->add("PENTAX Corporation", "PENTAX Optio S", 5.744f, 4.308f, 2048, 1536);
  this->add("Asahi Optical Co.,Ltd", "PENTAX Optio 430", 7.144f, 5.358f, 2240,
            1680);
  this->add("Asahi Optical Co.,Ltd", "PENTAX Optio 330", 7.144f, 5.358f, 2048,
            1536);
  ...
  this->add("SAMSUNG", "SAMSUNG WB650 / VLUU WB650 / SAMSUNG WB660", 6.17f,
            4.55f, 4000, 3000);
  this->add("SAMSUNG", "NX10", 23.4f, 15.6f, 4592, 3056);
  this->add("SAMSUNG", "WB5000/HZ25W", 6.08f, 4.56f, 4000, 3000);
  this->add("SAMSUNG", " SAMSUNG WB500 / VLUU WB500 / SAMSUNG HZ10W", 6.08f,
            4.56f, 3648, 2432);
  ...
  this->add("Samsung Techwin", "<Digimax V700 / Kenox V10>", 7.144f, 5.358f,
            3072, 2304);
